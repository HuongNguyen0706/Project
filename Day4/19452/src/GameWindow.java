...
public class GameWindow extends Frame implements Runnable {
    ...
    HealthBars healthBarMouse;
    HealthBars healthBarKey;
    Gift gift;
    ...
    private void initPlane(){
        healthBarMouse = new HealthBars(30, 45, 100, 10, 0, Color.pink);
        healthBarKey = new HealthBars(30, 30, 100, 10, 1, Color.gray );
        gift = new Gift(100, 100, 3);
